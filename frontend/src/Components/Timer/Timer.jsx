...
class Timer extends React.Component {
  ...
  setCircleDasharray(remainingTime) {
    ...
    const daysArray = `${(
      (days/30) * FULL_DASH_ARRAY).toFixed(0)} 407`;
    ...
    const hoursArray = `${(
      (hours/24) * FULL_DASH_ARRAY).toFixed(0)} 407`;
    ...
    const minutesArray = `${(
      (minutes/60) * FULL_DASH_ARRAY).toFixed(0)} 407`;
    ...
    const secondsArray = `${(
      (seconds/60) * FULL_DASH_ARRAY).toFixed(0)} 407`;
        ...
        <Col className="colStyle">
          <div className='groupStyle'>
              <div className='contain'>
                ...
                <svg id='image' xmlns='http://www.w3.org/2000/svg' version='1.1' width="144px" height="144px" >
                  <circle cx="72" cy="72" r="65" stroke-linecap="round"/>
                  <circle cx="72" cy="72" r="65" class='base-timer-path-remaining' id='daysTimer' strokeDasharray="90 380"/>
                </svg>
              </div>
          ...
          <div className='groupStyle'>
              <div className='contain'>
                <div id="number"> 
                {Math.floor((this.state.time % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60),)}
                </div>

                <svg xmlns='http://www.w3.org/2000/svg' version='1.1' width="144px" height="144px" >
                  <circle cx="72" cy="72" r="65" stroke-linecap="round"/>
                  <circle cx="72" cy="72" r="65" class='base-timer-path-remaining' id='hoursTimer' strokeDasharray="90 380"/>
                </svg>
              </div>
          ...
          <div className='groupStyle'>
              <div className='contain'>
                ...
                <svg id='image' xmlns='http://www.w3.org/2000/svg' version='1.1' width="144px" height="144px" >
                  <circle cx="72" cy="72" r="65" stroke-linecap="round"/>
                  <circle cx="72" cy="72" r="65" class='base-timer-path-remaining' id='minutesTimer' strokeDasharray="90 380"/>
                </svg>
              </div>
          ...
          <div className='groupStyle'>
              <div className='contain'>
                ...
                <svg xmlns='http://www.w3.org/2000/svg' version='1.1' width="144px" height="144px" >
                  <circle cx="72" cy="72" r="65" stroke-linecap="round"/>
                  <circle cx="72" cy="72" r="65" class='base-timer-path-remaining' id='secondsTimer' strokeDasharray="90 380"/>
                </svg>
              </div>
