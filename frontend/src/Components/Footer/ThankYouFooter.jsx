...
const Footer = () => {
    return (
        <div>
            <div className='footer-banner d-flex align-items-center justify-content-center' style={{ backgroundColor: '#910307', padding: '20px', fontFamily: 'Poppins Light', color: 'white' }}>
                <h3 className='mr-4 mb-0'>Support next year's event!</h3>
                <a href="https://tinyurl.com/hackrpi-donation" className='text-decoration-none'>
                    <Button
                        variant="outline"
                        style={{ backgroundColor: 'white', color: '#910307', cursor: 'pointer' }}
                    >
                        Donate!
                    </Button>
                </a>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 50, gap: 20 }}>
                <Nav.Link href='https://www.instagram.com/hack.rpi/?hl=en'>
                    <button className='Btn'>
                        ...
                        <span className="tooltip">@hack.rpi</span>
                    </button>
                </Nav.Link>
                ...
                <Nav.Link href='https://discord.gg/RZWU45CDrW'>
                    <button className='Btn'>
                        ...
                        <span className="tooltip">https://discord.gg/RZWU45CDrW</span>
                    </button>
                </Nav.Link>
